...
<head>
    ...
    <script>window.__APP_BASE = "{{ rtrim(asset('/'), '/') }}";</script>
...
<body class="dark-bg-main">
    ...
    {{-- game-header removed: game runs inside parent app iframe which has its own header --}}
                                    ...
                                    <div class="list-items">
                                        ...
                                        <div class="column-2">
                                            <button
                                                ...
                                                {{ number_format($item->amount, 2) }}{{ user('currency') }}
                                            </button>
                                        </div>
                                        <div class="column-3">
                                        ...
                                        <div class="column-4 fw-normal">
                                            {{ number_format($item->amount * $item->cashout_multiplier, 2) }}{{ user('currency') }}
                                        </div>
                                    </div>
                                @endforeach
                                    ...
                                    <div class="bets-opt-list">
                                        <button class="btn btn-secondary btn-sm bet-opt main_amount_btn"
                                            onclick="select_direct_bet_amount(this);"><span
                                                class="amt">100</span><span class="currency">{{ user('currency') }}</span></button>
                                        <button class="btn btn-secondary btn-sm bet-opt main_amount_btn"
                                            onclick="select_direct_bet_amount(this);"><span
                                                class="amt">200</span><span class="currency">{{ user('currency') }}</span></button>
                                        <button class="btn btn-secondary btn-sm bet-opt main_amount_btn"
                                            onclick="select_direct_bet_amount(this);"><span
                                                class="amt">500</span><span class="currency">{{ user('currency') }}</span></button>
                                        <button class="btn btn-secondary btn-sm bet-opt main_amount_btn"
                                            onclick="select_direct_bet_amount(this);"><span
                                                class="amt">1000</span><span class="currency">{{ user('currency') }}</span></button>
                                    </div>
                                </div>
                ...
                <div class="modal-body">
                    <ul class="list-unstyled limit-rules">
                        <li class="list-group-item">
                            Minimum Bet:
                            <span class="badge badge-success px-2 font-family-number">10 {{ user('currency') }} </span>
                        </li>
                        <li class="list-group-item">
                            Maximum Bet:
                            <span class="badge badge-success px-2 font-family-number">8000 {{ user('currency') }} </span>
                        </li>
                        <li class="list-group-item">
                            Maximum win for one bet:
                            <span class="badge badge-success px-2 font-family-number">800000 {{ user('currency') }} </span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    {{-- footer removed: game runs inside an iframe, parent app has its own footer --}}
    <!--====== Avatar Modal Start ======-->
    ...
    <script>
    if (window.jQuery && window.__APP_BASE) {
        $.ajaxPrefilter(function(options) {
            if (options.url && options.url.charAt(0) === '/' && options.url.charAt(1) !== '/') {
                options.url = window.__APP_BASE + options.url;
            }
        });
    }
    </script>
    ...
    <script src="{{ asset('user/avatar.js') }}"></script>
    <script src="{{ asset('user/canvas.js') }}"></script>
    <script src="{{ asset('user/aviatorold.js') }}?v={{env('APP_VERSION')}}"></script>
    <script src="{{ asset('user/aviatorbyapp.js') }}?v={{env('APP_VERSION')}}"></script>
