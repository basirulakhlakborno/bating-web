...
export type HomeGameMenuItem = {
  ...
  icon: string
  to: string
  /** Use `layoutIframeGamePlayHref` from API (DB iframe game id). */
  useIframeGameHref?: boolean
...
export const homeGameMenuItems: HomeGameMenuItem[] = [
  ...
  {
    title: 'ক্র্যাশ',
    holder: '/static/svg/gameTabHolder/crash.svg',
    icon: '/static/svg/mobileMenu/crash.png',
    to: '/',
    useIframeGameHref: true,
  },
